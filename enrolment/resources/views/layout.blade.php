        ...
        <ul class="navbar-nav ml-lg-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu navbar-dropdown mail-notification" aria-labelledby="MailDropdown">
              ...
              <a class="dropdown-item" href="{{URL::to('/user_profile')}}">
                <div class="sender-img">
                  <img src="http://via.placeholder.com/47x47" alt="">
                  <span class="badge badge-success">&nbsp;</span>
                </div>
                <div class="sender">
                  <p class="Sende-name">User Profile</p>
                </div>
              </a>


              <a class="dropdown-item" href="{{URL::to('/user_setting')}}">
                <div class="sender-img">
                  <img src="http://via.placeholder.com/47x47" alt="">
                  <span class="badge badge-success">&nbsp;</span>
                </div>
      ...
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            ...
            <div class="details">
              <p class="user-name">Md Anikul Islam</p>
          ...
          <ul class="nav">
            ...
            <li class="nav-item nav-category">
              <span class="nav-link">Attribute</span>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="layoutsSubmenu">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/add_student')}}">Add student</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{{URL::to('/all_student')}}">All Student</a>
                  </li>
                  <li class="nav-item">
