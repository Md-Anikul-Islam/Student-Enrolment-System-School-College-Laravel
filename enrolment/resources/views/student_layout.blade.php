...
<body class="sidebar-dark">
  ...
  <nav class="navbar navbar-light col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{URL::to('/student_dashboard')}}">Student Site</a>
      </div>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <div class="user-info">
            <div class="profile">
               ...
               <img src="{{URL::to($student_info->student_image)}}" style="height: 50px; width: 50px;">
            </div>
            <div class="details">
              <p class="user-name">Student</p>
              <p class="designation">{{($student_info->student_name)}}</p>
            </div>
          </div>
          <ul class="nav">
            <!--main pages start-->
