          ...
          <div class="card col-lg-4 mx-auto">
            <div class="card-body px-5 py-5">
             ...
             ?>
              ...
              <h3 class="card-title text-left mb-3">Login To Student</h3>
              <form method="post" action="{{url('/studentlogin')}}">
              @csrf
                <div class="form-group">
                  <label><b>Username or email *</b></label>
                  <input type="text" name="student_email" class="form-control p_input" placeholder="Enter your mail">
                </div>
                <div class="form-group">
                  <label><b>Password *</b></label>
                  <input type="password" name="student_password" class="form-control p_input" placeholder="Enter your password"> 
                </div>
